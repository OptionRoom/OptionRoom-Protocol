...
contract RoomNFT is ERC1155{
    ...
    constructor() public ERC1155("uri"){
            ...
            requiredRoomBurned[TIER2] = 120e18; // + burn 1 tire1
            requiredRoomBurned[TIER3] = 120e18; // + burn 1 tire2
            requiredRoomBurned[TIER4] = 120e18; // + burn 1 tire3
            requiredRoomBurned[TIER5] = 160e18; // + burn 1 tire4
    }
    ...
    function mintTier(uint256 id) public{
        ...
        if(id >0 ){
            burn(_msgSender(),id.sub(1),1); // burn previous tier
        }
